                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                        <div class="blog-details-content">
                                    ...
                                    <div class="lower-content">
                                        <div class="upper-box">
                                            ...
                                            <div class="text">
                                                ...
                                                <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident sunt culpa qui officia deserunt mollit anim id est laborum. Sed perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis.</p>
                                            </div>
                                        </div>
                                        <div class="two-column">
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                                                    <figure class="image-box"><img src="assets/images/news/news-23.jpg" alt=""></figure>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="lower-box">
                                            <p>Reprehenderit in voluptate velit esse cillum dolore fugiat nulla pariatur excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt ex mollit anim id est laborum sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.</p>
                                        </div>
                                ...
                                <div class="comment-box">
                                    <div class="comment">
                                        ...
                                        <div class="comment-inner">
                                            ...
                                            <div class="text">Ne erat velit invidunt his. Eum in dicta veniam interesset, harum fuisset te nam ea cu lupta definitionem.</div>
                                        </div>
                                    </div>
                            ...
                            <div class="comments-form-area">
                                ...
                                <form action="http://azim.commonsupport.com/Detox/blog-details.html" method="post" class="comment-form default-form">
                                    <div class="row">
